...
-(void)drawRect:(CGRect)rect
{
    ...
    float indLength=(pickerOrientation==ILHuePickerViewOrientationHorizontal) ? rect.size.height/2.5 : rect.size.width/2.5;
    ...
    if (pickerOrientation==ILHuePickerViewOrientationHorizontal)
    {
        CGContextMoveToPoint(context, pos-(indLength/2.5), 1.5);
        CGContextAddLineToPoint(context, pos+(indLength/2.5), 1.5);
